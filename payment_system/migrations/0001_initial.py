...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Money_Request'
        db.create_table(u'payment_system_money_request', (
            ...
            ('money_account', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('cdate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'payment_system', ['Money_Request'])


    def backwards(self, orm):
        # Deleting model 'Money_Request'
        db.delete_table(u'payment_system_money_request')
