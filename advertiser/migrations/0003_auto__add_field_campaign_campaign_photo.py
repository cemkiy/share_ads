...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.campaign_photo'
        db.add_column(u'advertiser_campaign', 'campaign_photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.campaign_photo'
        db.delete_column(u'advertiser_campaign', 'campaign_photo')
